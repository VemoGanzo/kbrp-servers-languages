DarkRP.RegisterSentences("kbrp_health", "fr", {
  ["npcTitle"] = "Médecin en Chef",
	...
	["cantAffordCare"] = "Vous n'avez pas l'argent pour vous soigner",
	["careInProgress"] = "Soins en cours...",
	["npcTooFar"] = "Vous êtes trop loin de votre médecin nous n'avons pas pu vous soigner",
	["beenCared"] = "Vous venez d'être soigné par les medecins de Kobralost",
